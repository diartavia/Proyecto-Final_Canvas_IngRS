...
public class JAsistencia extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
              public void run() {
            Materia materia = Sistema.getMateriaDemoPublica(); // o Sistema.getProfesorActual().getMateriaSeleccionada()
            if (materia != null) {
                new JAsistencia(materia).setVisible(true);
            } else {
                javax.swing.JOptionPane.showMessageDialog(null, "No hay materia seleccionada.");
            }
        }
        });
    }
