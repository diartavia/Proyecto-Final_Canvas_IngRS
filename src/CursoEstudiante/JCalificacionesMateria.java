...
public class JCalificacionesMateria extends javax.swing.JFrame {
    ...
    /*
            - Nota Developer 1:
        Constructor, en este frame se ven las notas del curso del estudiante de forma más específica de un estudiante en el curso
    ...
    */
    ...
    public void MostrarNotas(){
        jLabel_NombreEst.setText(estudiante.getNombre()); //se pone en el label el nombre del estudiante
        //se crea un objeto de tipo tabla
        DefaultTableModel model = (DefaultTableModel) TablaNotas.getModel();
        model.setRowCount(0); //se vacia la tabla
        double promedio = estudiante.calcularNotaFinal(mate); //se asigna el promedio
        JLabel_Nota.setText(String.format("%.2f", promedio));//se setea el label con el promedio

        //Para poner las asignaciones en la tabla
    ...
    */
    ...
    //Para ir a Anuncios estudiante (No esta hecha)
    ...
    //Para ir a cursos estudiante (No esta hecho)
    ...
    //Para ir al panel de asistencia
